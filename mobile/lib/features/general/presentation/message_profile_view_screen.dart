...
class MessageProfileViewScreen extends HookConsumerWidget {
  final ServiceProvider provider;

  const MessageProfileViewScreen({super.key, required this.provider});
    ...
    return Container(
      ...
      child: OutlinedButton(
        ...
        child: Row(
          ...
          children: [
            Icon(LucideIcons.star, color: theme.colorScheme.primary, size: 5.w),
            SizedBox(width: 2.w),
            Text(
              'Rate ${provider.name}',
              style: theme.textTheme.bodyMedium?.copyWith(
