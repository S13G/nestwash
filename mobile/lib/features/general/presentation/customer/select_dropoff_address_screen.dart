...
class SelectDropoffAddressScreen extends HookConsumerWidget {
  const SelectDropoffAddressScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final theme = Theme.of(context);
    final addresses = ref.watch(addressListNotifierProvider);
    final selectedAddress = ref.watch(selectedDropoffAddressProvider);
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Select where our rider should deliver your clean laundry',
                  ...
                  onPressed:
                      selectedAddress != null
                          ? () {
                            ...
                            // Complete the dropoff address step
  ...
  void _completeDropoffStep(WidgetRef ref) {
    // Mark step 2 (dropoff address) as completed
  ...
  Widget _buildModernAddressCard(
    ...
    return GestureDetector(
      onTap: () {
        ...
        ref.read(selectedDropoffAddressProvider.notifier).state = address;
      },
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Add an address in your profile to continue with laundry delivery',
              style: theme.textTheme.bodyMedium?.copyWith(
                color: theme.colorScheme.onPrimaryContainer,
