...
class LaundryOrdersScreen extends HookConsumerWidget {
    ...
    return SlideTransition(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildOrderCard(order, index, context, ref);
        },
      ),
    );
  }
      ...
      child: GestureDetector(
        onTap: () {
          ...
          if (accountType == "service_provider") {
            context.pushNamed("service_provider_order_details", extra: order);
          } else {
