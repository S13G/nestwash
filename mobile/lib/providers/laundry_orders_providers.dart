...
final laundryOrderSelectedFilterProvider = StateProvider<FilterType>(
  (ref) => FilterType.all,
);
final allLaundryOrdersProvider = Provider<List<Order>>(
  (ref) => Order.sampleOrder(),
);

final filteredLaundryOrdersProvider = Provider.family<List<Order>, String>((
  ref,
  searchQuery,
) {
